...
exports.migrateToMultiGroup = void 0;
...
exports.migrateToMultiGroup = functions.runWith({
    timeoutSeconds: 540,
    memory: '512MB'
    ...
    try {
        ...
        for (const [, docs] of groups.entries()) {
            ...
            if (masterData.group_ids && Array.isArray(masterData.group_ids)) {
                masterData.group_ids.forEach((id) => allGroupIds.add(id));
            }
            ...
            duplicates.forEach(dup => {
                ...
                if (dData.group_ids && Array.isArray(dData.group_ids)) {
                    dData.group_ids.forEach((id) => allGroupIds.add(id));
                }
                if (dData.group_id) {
