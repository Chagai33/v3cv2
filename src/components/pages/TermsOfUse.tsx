    ...
    <InfoPageLayout>
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm p-6 sm:p-8">
        ...
        <p className="text-sm text-gray-600 mb-8">
          {t('terms.lastUpdated', 'תאריך עדכון אחרון')}: 29 בדצמבר 2025
        </p>
        ...
        <div className="prose prose-sm max-w-none" dir={isHebrew ? 'rtl' : 'ltr'}>
          ...
          <section className="mb-6">
            ...
            <p className="text-gray-700 leading-relaxed">
              {t('terms.section1.content', 'האפליקציה מספקת פלטפורמה לניהול, ריכוז ומעקב אחר ימי הולדת. השירות מאפשר למשתמשים ליצור "קבוצות" (Groups) לניהול רשימות ימי הולדת, להזין פרטי ימי הולדת (כולל תאריך לועזי, תאריך עברי, מין וציון "אחרי השקיעה"). בעת יצירת "לינק שיתוף" לקבוצה, מחזיקי הלינק יכולים לצפות ברשומות הקבוצה ולהוסיף רשומות חדשות. מסיבות אבטחה, תוקף לינקי השיתוף מוגבל ל-72 שעות. האפליקציה כוללת חישוב מקומי אוטומטי של תאריכים עבריים ואפשרות לסנכרון עם יומן Google האישי של המשתמש.')}
            </p>
          </section>
          ...
          <section className="mb-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-3">
              {t('terms.section6.title', '6. איסוף נתוני שימוש וניטור אבטחה')}
            </h2>
            <div className="text-gray-700 leading-relaxed space-y-3">
              <p>
                {t('terms.section6.intro', 'לצורך שיפור השירות והבטחת פעולתו התקינה, אנו אוספים נתוני שימוש אנונימיים באמצעות Google Analytics 4. נתונים אלו כוללים דפוסי שימוש, מידע טכני על הדפדפן והמכשיר, ואירועי שימוש כלליים.')}
              </p>
              <div>
                <strong className="text-gray-900">{t('terms.section6.subtitle1', 'ניטור פעולות בכמויות גדולות:')}</strong>
                <p className="mt-1">
                  {t('terms.section6.content1', 'לצורך מניעת שימוש לרעה ושמירה על יציבות המערכת, אנו מנטרים פעולות בכמויות חריגות (כגון ייבוא, סנכרון או מחיקה של יותר מ-50 רשומות בבת אחת). ניטור זה אינו כולל פרטים אישיים של אנשי הקשר.')}
                </p>
              </div>
              <div>
                <strong className="text-gray-900">{t('terms.section6.subtitle2', 'איסור על חילוץ מידע אוטומטי (Scraping):')}</strong>
                <p className="mt-1">
                  {t('terms.section6.content2', 'אין לבצע חילוץ מידע אוטומטי מהאפליקציה באמצעות סקריפטים, בוטים או כלים אוטומטיים אחרים. שימוש כזה מהווה הפרה של תנאי השימוש ועלול לגרום לחסימת החשבון.')}
                </p>
              </div>
              <p>
                {t('terms.section6.optout', 'ניתן לבטל את איסוף נתוני האנליטיקס באמצעות הגדרות הדפדפן או התקנת תוסף Google Analytics Opt-out. פרטים נוספים זמינים במדיניות הפרטיות.')}
              </p>
            </div>
          </section>
          ...
          <section className="mb-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-3">
              {t('terms.section9.title', '9. סמכות שיפוט')}
            </h2>
            <p className="text-gray-700 leading-relaxed">
              {t('terms.section9.content', 'על תנאי שימוש אלו יחולו דיני מדינת ישראל. סמכות השיפוט הבלעדית בכל סכסוך תהא נתונה לבתי המשפט המוסמכים במחוז תל אביב-יפו.')}
            </p>
          </section>
